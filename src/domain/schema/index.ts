...
export type ShortCharacterFragment = {
  __typename?: "Character";
  id?: string | null;
  name?: string | null;
  image?: string | null;
...
export function useGetOneCharacterQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetOneCharacterQuery, GetOneCharacterQueryVariables>(
...
export function useGetOneCharacterLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetOneCharacterQuery,
    GetOneCharacterQueryVariables
  >(GetOneCharacterDocument, options);
}
export type GetOneCharacterQueryHookResult = ReturnType<
  typeof useGetOneCharacterQuery
>;
export type GetOneCharacterLazyQueryHookResult = ReturnType<
  typeof useGetOneCharacterLazyQuery
>;
export type GetOneCharacterQueryResult = Apollo.QueryResult<
  GetOneCharacterQuery,
  GetOneCharacterQueryVariables
>;
