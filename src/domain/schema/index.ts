 ...
 *
 * To run a query within a React component, call `useGetOneCharacterQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOneCharacterQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOneCharacterQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetOneCharacterQuery(baseOptions: Apollo.QueryHookOptions<GetOneCharacterQuery, GetOneCharacterQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetOneCharacterQuery, GetOneCharacterQueryVariables>(GetOneCharacterDocument, options);
      }
export function useGetOneCharacterLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOneCharacterQuery, GetOneCharacterQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetOneCharacterQuery, GetOneCharacterQueryVariables>(GetOneCharacterDocument, options);
        }
export type GetOneCharacterQueryHookResult = ReturnType<typeof useGetOneCharacterQuery>;
export type GetOneCharacterLazyQueryHookResult = ReturnType<typeof useGetOneCharacterLazyQuery>;
export type GetOneCharacterQueryResult = Apollo.QueryResult<GetOneCharacterQuery, GetOneCharacterQueryVariables>;